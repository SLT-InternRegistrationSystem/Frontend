...
import {Button, Select, SelectItem, Input, Pagination, Tooltip, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, useDisclosure, Textarea} from "@nextui-org/react";
            ...
            {editingIntern ? (
              <div>
                ...
                <div className="grid grid-cols-2 mt-16 gap-y-5 gap-x-7 m-auto">
                  ...
                  <Select label="Supervisor" labelPlacement="outside" placeholder={editingIntern.supervisor} value={editingIntern.supervisor} onChange={(e) => setEditingIntern({ ...editingIntern, supervisor: e.target.value })} type="text">
